...
(function(){
   ...
   * @return {array} allLayers Array con grupos y capas.
   */
  ...
  var SQUERY = function(selector, page, artboard) {
     ...
     * @return {artboard}
     */
    function getCurrentOrFirstArtboard() {
      var currentPage = doc.currentPage();
      if(currentPage.currentArtboard()){
        return currentPage.currentArtboard()
      } else {
        return currentPage.artboards()[0]
      }
    }
